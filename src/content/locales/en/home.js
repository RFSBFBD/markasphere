export default {
  ...
  home: {
    ...
    twoColTitle: "The way a brand appears… has become part of its value.",
    twoColIntro: "In a market filled with similarity, brands are no longer compared by services alone.",
    twoColItems: [
      "Presence",
      "Impression",
      "Presentation",
      "The image they reflect"
    ],
    twoColClosing: "That is why we do not treat design and marketing as separate elements, but as a complete system for building brand presence.",
